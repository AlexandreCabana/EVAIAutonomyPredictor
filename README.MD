...
traditionelle, car le corp humain ne peut pas observer une fonction qui a plus que deux paramètres. Ainsi, il faut être ingénieux pour représenter une fonction à plus de variable avec des graphiques. 
