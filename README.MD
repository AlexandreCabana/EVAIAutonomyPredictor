...
### Un framework est une structure de base pour construire un projet avec de nombreux outils. Dans le cas de FastAPI, il permet de recevoir/envoyer des informations au site web avec Python.
